...
from funcions import loop_fill_split, pipeline_processat_train
from config import pol_arxiu, data_inici, area_geo, nom_area, contaminant, meteo_arxiu, var_arxiu, est_arxiu, pol_csv, meteo_csv, var_csv, est_csv, csv_path
...
if __name__ == '__main__':
    ...
    x_train, y_train, enc, scaler, best_score, best_estimator = pipeline_processat_train(data=train_df, var_list=var_list)
